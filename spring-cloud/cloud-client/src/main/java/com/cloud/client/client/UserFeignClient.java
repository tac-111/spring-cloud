...
import com.cloud.client.log.FeignConfiguration;
...
@FeignClient(name = "cloud-provider", configuration = FeignConfiguration.class,fallbackFactory = FeignClientFallbackFactory.class)
public interface UserFeignClient {
    ...
    @RequestMapping(value = "getFeignTo")
